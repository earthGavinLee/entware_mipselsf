...
# PK_NAME_25volt="/home/ryzhovau/Entware/openwrt_chaos_calmer_entware/feeds/rtndev/25volt/"
...
ROOT_PATH=$(cd ../../../openwrt_chaos_calmer_entware && pwd -P)

# Short path to package folder, relative to the openwrt_chaos_calmer_entware folder
SHORT_PATH=${FULL_PATH#${ROOT_PATH}/}

# A basic packages from openwrt_chaos_calmer_entware/package is not indexed, trying
# to find it manually
[ -z "$SHORT_PATH" ] && \
    SHORT_PATH=$(find ../../../openwrt_chaos_calmer_entware/package/ -type d -name $PKG_NAME | \
	sed 's/^\.\.\/\.\.\/\.\.\/openwrt_chaos_calmer_entware\///' | head -n 1)
...
case $1 in
-r)
    diff -urx .svn ../../../downloads/openwrt_chaos_calmer_entware-r${OPENWRT_REVISION}/${SHORT_PATH} \
	../../../openwrt_chaos_calmer_entware/${SHORT_PATH}
    ;;
*)
    diff -u ../../../downloads/openwrt_chaos_calmer_entware-r${OPENWRT_REVISION}/${SHORT_PATH}/Makefile \
	../../../openwrt_chaos_calmer_entware/${SHORT_PATH}/Makefile
    ;;
esac
